		...
		return this.each(function(i,e) {
			...
			item.click(function() {
				$(this)
					...
					.next()
						.toggleClass(parameters.activeClass)
						.slideToggle(parameters.speed, parameters.easing, function() {
							parameters.openCallback($(this));
						});
				return false;
			});
		...
		return this.each(function(i,e) {
			...
			items.each(function(j, item) {
				...
				item.find("a").click(function() {
					...
					$(activeTab).slideDown(parameters.speed, parameters.easing, function() {
						parameters.openCallback($(this));
					});
			...
			items.each(function(j,item) {
				...
				title.click(function() {
					...
					if(content.css("display") == "none") {
						parent.find("."+parameters.contentClass).slideDown(parameters.speed, parameters.easing, function() {
							parameters.openCallback($(this));
						});
