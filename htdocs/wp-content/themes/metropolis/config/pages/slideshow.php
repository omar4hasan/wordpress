...
$field = array(
	"Slideshow" => array(
		"infobox" => "<p>To manage your custom collection of slides, go to the 'Slideshow' option page. Upon clicking the 'Add' button, a panel is presented to you with the ability to choose the type of the slide, being it Picture or Video.<br /><br />
