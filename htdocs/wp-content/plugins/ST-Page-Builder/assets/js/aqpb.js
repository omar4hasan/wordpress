...
jQuery(document).ready(function($){
	...
	function block_size(width) {
		...
		if (width > 0 && width < 130){ span = "col-md-2"; }
		else if (width == 166){ span = "col-md-3"; }
		else if (width == 228){ span = "col-md-4"; }
		else if (width == 290){ span = "col-md-5"; }
		else if (width == 352){ span = "col-md-6"; }
		else if (width == 414){ span = "col-md-7"; }
		else if (width == 476){ span = "col-md-8"; }
		else if (width == 538){ span = "col-md-9"; }
		else if (width == 600){ span = "col-md-10"; }
		else if (width == 662){ span = "col-md-11"; }
		else if (width == 724){ span = "col-md-12"; }
	...
	$(document).on('click', '#page-builder a.block-edit1', function() {
		var blockID = $(this).parents('li').attr('id');
		$('#' + blockID + ' .block-settings.columm').slideToggle('fast');
	...
	/** addClass and removeClasses active in a.block-edit, a.block-edit1 **/
	$(document).on('click', '#page-builder a.block-edit', function() {
