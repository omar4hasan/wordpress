...
if (have_posts())
    while ($wp_query->have_posts()):
        ...
        echo '
    <div class="bl1page-archive">';
        if ($image_id) {
            echo '
		<div class="bl1page-cover">';
            if ($vimeo or $youtube) {
                echo '
			<a href="' . get_permalink() . '"><div class="bl1page-cover-video"></div></a>';
            }
            echo '
        ...
        echo '
		<h2 class="bl1page-title"><a href="' . get_permalink() . '">' . get_the_title($post->ID) . '</a></h2>
		<div class="bl1page-info">' . get_the_time('F jS, Y') . ' | by <a href="' . get_author_posts_url($author) . '">' . get_the_author() . '</a></div>';
        echo '' . get_excerpt(280) . '';
        echo '
		<a href="' . get_permalink() . '"><span class="bl1page-link">' . __('Read more', 'wizedesign') . '</span></a>
    </div><!-- end .bl1page-archive -->
';
    endwhile;
...
<div id="sidebar-left">';
        ...
        if (!function_exists('dynamic_sidebar') || !dynamic_sidebar('blog-one-page'));
        echo '
