...
$sections = array(
	"General" => array(
		"fields" => array(
			array( 
				"name" => "Logo",
				"desc" => "Upload an image to be used as a logo for your site, or paste its URL. If this field is left empty, the default logo will be used.",
				"key" => "_logo_url",
				"type" => "upload",
				"std" => ""
			),
	...
	"Social" => array(
		"fields" => array(
			...
			array(
				"name" => "Twitter API",
				"desc" => '<strong>As per version 1.1 of the official Twitter API system, the following settings are REQUIRED in order for the Twitter widget and shortcode to work.</strong>
<ol>
	...
	<li>Copy the <strong>Consumer key</strong>, <strong>Consumer secret</strong>, <strong>Access token</strong> and <strong>Access token secret</strong> from your Twitter application page into the settings below.</li>
			...
			array(
				...
				"key" => "_twitter_oauth_token_secret",
				"type" => "text",
				"std" => ""
			)
		)
