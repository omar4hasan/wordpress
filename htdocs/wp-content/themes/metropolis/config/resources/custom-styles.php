...
<?php 
	$border_color = thb_get_option("_submenu_background_color");
	
	if( $border_color == "FFFFFF" ) :
		cssRule("border-top-color", "#eaeaea");
	else : 
		cssRule("border-top-color", lighten("#" . thb_get_option("_submenu_background_color"), 10)); 
	endif;
	?>
}
