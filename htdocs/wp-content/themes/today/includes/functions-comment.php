<?php
function wizedesign_comment_reply() {
    if (is_singular() && comments_open() && get_option('thread_comments')) {
        // enqueue the javascript that performs in-link comment reply fanciness
        wp_enqueue_script('comment-reply');
    }
}
add_action('wp_print_scripts', 'wizedesign_comment_reply');
...
?>
                <em class="comment-awaiting-moderation"><?php _e('Your comment is awaiting moderation.', 'wizedesign'); ?></em>
                            <br />
                        <?php
                endif;
?>
