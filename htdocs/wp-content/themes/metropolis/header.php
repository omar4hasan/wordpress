...
<html <?php language_attributes(); ?>>
	<head>
		<!-- Theme version: <?php echo THEMEVERSION; ?> -->
		...
		<link rel="stylesheet" media="all" href="<?php echo $template_directory_uri; ?>/css/reset.css" />
		<link rel="stylesheet" media="all" href="<?php echo $template_directory_uri; ?>/css/framework.css" />
		<link rel="stylesheet" media="all" href="<?php echo $template_directory_uri; ?>/css/layout.css" />
		<link rel="stylesheet" media="all" href="<?php echo $template_directory_uri; ?>/css/print.css" />
		<!-- Plugins stylesheets -->
		<link rel="stylesheet" media="all" href="<?php echo $template_directory_uri; ?>/css/prettyPhoto.css" />
		<link rel="stylesheet" media="all" href="<?php echo $template_directory_uri; ?>/css/flexslider.css" />
		<!-- Custom stylesheets -->
