...
define( 'NOTIFIER_THEME_FOLDER_NAME', NOTIFICATIONFOLDER ); // The theme folder name
define( 'NOTIFIER_XML_FILE', NOTIFICATIONSURL. '/' . NOTIFICATIONFOLDER . '.xml' ); // The remote notifier XML file containing the latest version of the theme and changelog
...
function update_notifier_menu() {  
	...
	if (function_exists('simplexml_load_string')) { // Stop if simplexml_load_string funtion isn't available
		...
		if( (float)$xml->latest > (float) $version) { // Compare current theme version with the remote XML version
...
function update_notifier_bar_menu() {
	if (function_exists('simplexml_load_string')) { // Stop if simplexml_load_string funtion isn't available
		global $wp_admin_bar, $wpdb, $version;
